...
data <- readxl::read_excel("data.xlsx",
                           sheet = "TBDR sequencing data",
                           na = "NA")
demographic_data <-readxl::read_excel("data.xlsx",
                                      sheet = "demographic data",
                                      na = "NA")
data_long <- readxl::read_excel("data.xlsx",
                                sheet = "TBDR drug-level data",
                                na = "NA")
dta_df <- readxl::read_excel("data.xlsx",
                             sheet = "DTA data",
                             na = "NA",
                             col_types = c("text","text","text","text", "text","logical", "logical", "text","text","text","text","text","text","text","text","text","text","text"))
...
#ggsave("figures/plot_sequencing_success.tiff", sequencing_success_plot, width = 26.8, height = 24.4, units = "cm", dpi = 300)
```
...
plot_data <- data_long %>% 
  mutate (
    ...
    result = case_when(qc_status == "fail" ~ "sample sequencing failed",
                       ...
                       result == "sensitive" ~ "drug susceptible"),
...
ggsave("figures/targetplot.tiff", plot, width = 26.8, height = 24.4, units = "cm", dpi = 300)
```
...
Forest (combined_dta_tables, 
        ...
        col.headers = headers,
        #save_plot = "./figures/DTA_sediment",
        res = 300
        )
